      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white ">
        ...
        <section className="container mx-auto px-4 py-16" id="Features">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="bg-white/50 backdrop-blur-sm border-none shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                Stay updated with the latest university news. React, comment,
        ...
        <section className="container mx-auto px-4 py-20 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Join UB Talk today and become part of a vibrant community dedicated
            to making your university life better.
          </p>
